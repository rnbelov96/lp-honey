...
const initTranslateXPos = translateXPosList.find(el => el.mode === mode)?.pos as number;
...
const imagesBoxEl = document.querySelector('.certificates-slider__img-box') as HTMLDivElement;
const wrapperEl = document.querySelector('.certificates-slider__wrapper') as HTMLDivElement;
...
const prevBtnEl = document.querySelector('.certificates-slider__btn-prev') as HTMLButtonElement;
const nextBtnEl = document.querySelector('.certificates-slider__btn-next') as HTMLButtonElement;
